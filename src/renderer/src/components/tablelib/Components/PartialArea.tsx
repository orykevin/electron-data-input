...
export const PartialArea: React.FC<PartialAreaProps> = ({ range, pane, style, className }) => {
  ...
  const height =
    (range.last.row.idx > pane.last.row.idx ? pane.last.row.bottom : range.last.row.bottom) - top
