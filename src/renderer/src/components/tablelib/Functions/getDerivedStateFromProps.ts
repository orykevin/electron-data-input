...
export const highlightsHasChanged = (props: ReactGridProps, state: State): boolean =>
  props.highlights !== state.props?.highlights
...
export function updateFocusedLocation(_props: ReactGridProps, state: State): State {
